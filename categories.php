				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="number" class="form-control text-right" onKeyDown="return false" min="1" step="any" name="price">
							</div>
		...
		$.ajax({
			...
			success:function(resp){
				if(resp==1){
					...
					alert_toast("Please Fill the complete form",'success')
					setTimeout(function(){
						location.reload()
					},1500)
				}
		...
		$.ajax({
			...
			success:function(resp){
				if(resp==1){
					...
					alert_toast("There are orders with this category so cannot DELETE",'success')
					setTimeout(function(){
						location.reload()
					},3500)
				}
