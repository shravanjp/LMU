	...
	<form action="" id="manage-inv">
		...
		<div class="form-group">
			...
			<div class="form-group">	
				...
				<input type="number" step="any" onKeyDown="return false" min="1" value="<?php echo isset($qty) ? $qty : 1 ?>" class="form-control text-right" name="qty">
			</div>
			<div class="form-group">	
	...
	$('#manage-inv').submit(function(e){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp>1){
					alert_toast("Available stock is less than "+resp,'success')
					setTimeout(function(){
						location.reload()
					},3000)
				}
