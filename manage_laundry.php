			...
			<div class="row">	
				...
				<div class="col-md-4">	
					<div class="form-group">	
						...
						<input type="number" step="any" onKeyDown="return false" min="1" value="1" class="form-control text-right" id="weight">
					</div>
				</div>
				<div class="col-md-4">	
					<div class="form-group">	
					...
					<tbody>
						...
						?>
							<tr data-id="<?php echo $row['id'] ?>">
								...
								<td><input type="number" class="text-center" name="weight[]" id="" onKeyDown="return false" min=1 value="<?php echo $row['weight'] ?>"></td>
			...
			<div class="row">
				<div class="form-group">
					<div class="custom-control custom-switch" id="pay-switch">
					  <input type="checkbox" class="custom-control-input" value="1" name="pay" id="paid" <?php echo isset($pay_status)? 'checked' :'' ?>>
		...
		$.ajax({
			...
			success:function(resp){
				if(resp==1){
					...
					alert_toast("Please fill the name field",'success')
					setTimeout(function(){
						location.reload()
					},1500)
				}
